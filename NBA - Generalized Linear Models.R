...
## Predictors counting {.tabset .tabset-fade}
### Current
a <- main %>%
...
## Predictors extracting {.tabset .tabset-fade}
# Sep predictors
sep <- inner_join(
  pred1,
  pred2,
...
# Modeling
## Predicting O/U with regression {.tabset .tabset-fade}
...
## Predicting O/U with classification {.tabset .tabset-fade}
### Building a model
# full data
tic()
